...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 718016,
    DYNAMIC_BASE = 5960896,
    DYNAMICTOP_PTR = 717856;
...
var wasmBinaryFile = 'xerces-app.wasm';
...
var ASM_CONSTS = {
  1070: function($0) {alert("String: " + UTF8ToString($0))},  
 1151: function() {FS.syncfs(function(err) { assert(!err); ccall('success', 'v'); });},  
 1329: function() {out("call syncfs and CreateXML"); FS.syncfs(true, function(err) { assert(!err); ccall('CreateXML', 'v'); });},  
 1451: function() {FS.syncfs(true, function(err) { assert(!err); ccall('ReadXML', 'v'); });},  
 1539: function() {FS.syncfs(true, function(err) { assert(!err); ccall('DeleteXML', 'v'); });},  
 1643: function() {FS.mkdir('/mydir'); FS.mount(IDBFS, {}, '/mydir/'); FS.syncfs(true, function(err) { assert(!err); ccall('success', 'v'); });}
};
...
/** @type {function(...*):?} */
var _success = Module["_success"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["success"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _consoleLogString = Module["_consoleLogString"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["consoleLogString"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _CreateXML = Module["_CreateXML"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["CreateXML"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ReadXML = Module["_ReadXML"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ReadXML"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _DeleteXML = Module["_DeleteXML"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["DeleteXML"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _CreateXML_API = Module["_CreateXML_API"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["CreateXML_API"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ReadXML_API = Module["_ReadXML_API"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ReadXML_API"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _DeleteXML_API = Module["_DeleteXML_API"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["DeleteXML_API"].apply(null, arguments)
};
...
/** @type {function(...*):?} */
var dynCall_viiiiiiijj = Module["dynCall_viiiiiiijj"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiiijj"].apply(null, arguments)
};
